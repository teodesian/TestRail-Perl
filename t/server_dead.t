...
is( $tr->createTestSuite( 1, 'zugzug' ), -500,
    'createTestSuite returns error' );
...
is( $tr->getMilestoneByName( 1, 'hug' ),
    -500, 'getMilestoneByName returns error' );
...
is( $tr->getPossibleTestStatuses(),
    -500, 'getPossibleTestStatuses returns error' );
...
is( $tr->getSectionByName( 1, 1, 'zip' ),
    -500, 'getSectionByName returns error' );
...
is( $tr->getTestSuiteByName( 1, 'zap' ),
    -500, 'getTestSuiteByName returns error' );
